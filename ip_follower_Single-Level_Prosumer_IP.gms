...
parameters gamma_cpp(Gamma)     Dummy parameters for CPP markup ;
...
solve smart_grid using mip maximizing obj_ir_lower ;
...
file results /ip_follower_Single-Level_Prosumer_IP.dat/ ;
put results ;
put '# Smart Grid Results'//;
results.nd = 20;
results.nw = 0; 
results.pw = 10000; 
put 'Objective Function Value of the Upper Level for conventional tariff' @75,  obj_ir_upper.l /;
put/;
put 'Objective Function Value of the Lower Level for conventional tariff' @75,  obj_ir_lower.l /;
put/;
...
file results_csv /ip_follower_Single-Level_Prosumer_IP.csv/ ;
put results_csv ;
results_csv.nd = 20;
results_csv.nw = 0;
results_csv.nr = 0;
...
*file gamma_ret_bilevel /gamma_ret_bilevel.dat/ ;
*put gamma_ret_bilevel ;
*gamma_ret_bilevel.nd = 15; gamma_ret_bilevel.nr = 2; gamma_ret_bilevel.nw = 0; put 'scalar gamma_ret' @40, put '/' gamma_ret put '/' /;

*file gamma_cpp_bilevel /gamma_cpp_bilevel.dat/ ;
*put gamma_cpp_bilevel ;
*gamma_cpp_bilevel.nd = 10;
*put 'parameters gamma_cpp(Gamma) CPP markup in a bilevel optimal solution'/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20, gamma_cpp(Gamma) /);
*put '/'/;

*file P_im_bilevel /P_im_bilevel.dat/ ;
*put P_im_bilevel ;
*P_im_bilevel.nd = 10;
*put 'parameters P_im_bilevel(Gamma) Electrical power imported by prosumer in bilevel optimal solution'/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20, P_im.l(Gamma) /);
*put '/'/;
...
*put '/'/;
*loop((Gamma), results.nd = 10; put Gamma.tl, @20,  l_chp_e_upper.l(Gamma) /);
*put '/ ;'/;
...
*put /;
*
*put 'parameters l_elec_bal_up(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,  	  l_elec_bal.l(Gamma) /);
*put '/ ;'/;
*put 'parameters l_hsu_input_up(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,  	  l_hsu_input.l(Gamma) /);
*put '/ ;'/;
*put 'parameters l_bat_bal_up(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,          l_bat_bal.l(Gamma) /);
*put '/ ;'/;
*put 'parameters l_hsu_bal_up(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,          l_hsu_bal.l(Gamma) /);
*put '/ ;'/;
*put 'parameter l_init_hsu_up' 
*put /;
*put '/' l_init_hsu.l '/ ;'
*put /;
...
*put /;
*
*put 'parameters l_elec_bal_lo(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,  	  l_elec_bal.l(Gamma) /);
*put '/ ;'/;
*put 'parameters l_hsu_input_lo(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,  	  l_hsu_input.l(Gamma) /);
*put '/ ;'/;
*put 'parameters l_bat_bal_lo(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,          l_bat_bal.l(Gamma) /);
*put '/ ;'/;
*put 'parameters l_hsu_bal_lo(Gamma) '/;
*put '/'/;
*loop((Gamma), put Gamma.tl, @20,          l_hsu_bal.l(Gamma) /);
*put '/ ;'/;
*put 'parameter l_init_hsu_lo'
*put /;
*put '/' l_init_hsu.l '/ ;'
*put /;
*put 'parameter l_init_bat_lo'
*put /;
*put '/' l_init_bat.l '/ ;'
*put /;